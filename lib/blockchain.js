...
export function setup() {
  ...
  const bettingContract = new ethers.Contract(
    ...
    [
      'function createSportEvent(string title, uint256 startTime, uint8 gender, uint8 sport, string[] choices, uint32[] initialVotes, uint256 initialPool, bytes32 _uid) payable',
